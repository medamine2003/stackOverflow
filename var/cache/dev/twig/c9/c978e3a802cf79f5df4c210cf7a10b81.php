...
class __TwigTemplate_b35e36d066621a52b880d323d0b0ecd7 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["comment"]) {
            ...
            echo "</td>
                <td>";
            // line 21
            ((twig_get_attribute($this->env, $this->source, $context["comment"], "date", [], "any", false, false, false, 21)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["comment"], "date", [], "any", false, false, false, 21), "Y-m-d H:i:s"), "html", null, true))) : (print ("")));
            echo "</td>
                <td>";
            // line 22
...
{% endblock %}
", "comment/index.html.twig", "C:\\Users\\Argen\\Documents\\stackOverflow\\templates\\comment\\index.html.twig");
    }
}
